...
# 计算与目标点的距离，来定义适应度函数
def ev_pop(pop_size, pop_value, target_point):
...
def main(argv):
    ...
    loss = ev_pop(FLAGS.pop_size, pop_value, target_point)
    ...
    spn_plotting.plt_ev_result_with_point(FLAGS.plot_dir, target_point, output)
